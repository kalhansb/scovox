"""SCovox-NP: Beta occupancy + Naive Projection semantics on Replica.

Ablation variant: replaces Dirichlet with naive projection (last-write-wins).
Same as replica_eval.launch.py but semantic_mode=naive.
"""
