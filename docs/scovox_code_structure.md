...
- **§2 The current code** is this repository at commit `142545f`. The
  `DirVoxel` total-basis change, the `nhit` removal and the `SCOVOX_BETA_U16`
  default flip were committed in `d0a3c3e`; the promoted-configuration file and
  an off-lattice test fix in `142545f`. They were uncommitted when this
...
repository**: `d0a3c3e` swept `src`, `config` and `README.md` under the standing
