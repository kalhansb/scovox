...
- **§2 The current code** is this repository at commit `7f45ec9`, re-pinned
  and re-audited on 2026-09-05. It was first written against `142545f` and the
...
numbers are working-tree line numbers at `7f45ec9` (2026-09-05) and will
...
Line counts at `7f45ec9`: `scovox_node.cpp` 3421, `sem_split_map.cpp`
