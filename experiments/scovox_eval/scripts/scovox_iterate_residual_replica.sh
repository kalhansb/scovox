...
CELLS=(
  "res_all_old_knobs|evidence_saturation:=1000 semantic_min_confidence:=0.1 gate_k:=12.0 gate_tau:=0.5 dirichlet_min_p_occ:=0.6"
  "res_jitter_check|"
)
...
run_cell() {
    ...
    echo "━━ ${cell_name}  (extras: ${overrides[*]:-none}) ━━"
