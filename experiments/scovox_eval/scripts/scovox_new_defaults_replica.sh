#!/bin/bash
# Verification: new defaults (sat=1000, dir_min=0.5, smc/gate_k/gate_tau removed).
# Should reproduce res_step_bayesian within noise — confirms removing the
# redundant knobs didn't break anything.
set -eo pipefail
...
echo "━━ ${CELL_NAME}  (new defaults: sat=1000, dir_min=0.5; smc/gate_k removed) ━━"
